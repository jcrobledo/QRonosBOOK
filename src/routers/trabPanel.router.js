...
const { rulesAuth, rulesPass, rulesIncNewFich, rulesIncUpdateFich, validate } = require('../middlewares/validatorExpressTrab');
...
router.post("/incidencias/crear", vToken.verifyTokenTrab, rulesIncNewFich, validate, controller.createIncidencia);
router.get("/incidencias/modificar", vToken.verifyTokenTrab, controller.modificarIncidencia);
router.post("/incidencias/modificar", vToken.verifyTokenTrab, rulesIncUpdateFich, validate, controller.modificarIncidencia);
router.post("/incidencias/modificarReg", vToken.verifyTokenTrab, rulesIncUpdateFich, validate, controller.updateIncidencia);
router.get("/incidencias/eliminar", vToken.verifyTokenTrab, controller.eliminarIncidencia);
router.post("/incidencias/eliminar", vToken.verifyTokenTrab, rulesIncUpdateFich, validate, controller.eliminarIncidencia);
router.post("/incidencias/eliminarReg", vToken.verifyTokenTrab, rulesIncUpdateFich, validate, controller.deleteIncidencia);
